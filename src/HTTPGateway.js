{
    ...
    module.exports = class HTTPGateway extends Service {

        constructor(options) {
            if (!type.object(options)) throw new Error(`The HTTPGateway is missing the options object!`);
            ...
            // headers are being parsed and cached
